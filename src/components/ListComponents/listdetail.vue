...
.text-content-container {
  display: flex;
  justify-content: space-between; /* 让两端元素左右对齐 */
  align-items: center;
  margin-right: 50px;
}
...
.store-info {
  display: flex;
  flex-direction: column; /* 声明为纵向布局 */
  align-items: flex-start; /* 对齐方式设置为左对齐 */
  margin-bottom: 20px;
}

.store-info-top {
  display: flex;
  flex-direction: column; /* 确保店名和地址垂直排列 */
}

.store-name {
  font-size: 16px;
  font-weight: bold;
  margin-bottom: 5px; /* 添加一些间距，避免紧密靠在一起 */
}
